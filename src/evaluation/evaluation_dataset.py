...
EVALUATION_DATASET = [
    ...
    EvaluationCase(
        question="Based on Project Phoenix, how does it compare with the latest AI assistant trends?",
    ...
    EvaluationCase(
        question="Based on the leave policy, what are the latest trends in employee leave management?",
        expected_route=QueryRoute.BOTH,
        expected_sources=("LeavePolicy.pdf",),
        description="Tests policy evidence combined with current web research.",
    ),
]